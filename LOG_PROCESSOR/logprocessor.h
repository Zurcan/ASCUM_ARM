...
//#include <string.h>
#include <QVector>
#include <../../ASCUM_ARM/_SHARED_LIBRARIES/log.segments.h>
class logProcessor
{
   // Q_OBJECT
private:
...
public:
    ...
    bool readRecordByNumber(int recCount, int Size, int savedDataPointer, int recNum);
    ...
    bool clearBuff();
    long setTmpID();
    bool readTimeInversionFlag();
    long getSegmentFlags(); //if segment is selected
